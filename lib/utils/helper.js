  ...
  //  if(options.all) {      
        ...
        Object.keys(packageInfoCache).forEach( key => {
            ...
            if(value instanceof PackageInfo && value.isAddon()) {
                if(!this.project.pkg.prebuild || (this.project.pkg.prebuild && this.project.pkg.prebuild.blacklistAddons && !this.project.pkg.prebuild.blacklistAddons.includes(value.name))) {
